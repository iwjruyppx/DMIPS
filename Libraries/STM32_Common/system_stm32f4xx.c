...
#ifdef SYSCLK_FREQ
 #define PLL_N      ((SYSCLK_FREQ*2)/1000000)
#else
 #define PLL_N      336
...
/** @addtogroup STM32F4xx_System_Private_Variables
  ...
  */
  ...
  uint32_t SystemCoreClock = SYSCLK_FREQ;//168000000;
...
#if 1
/******************************************************************************/
/*            HSI used as System clock source (without PLL)                   */
/******************************************************************************/
    RCC_HSICmd(ENABLE);
    while (RCC_GetFlagStatus(RCC_FLAG_HSIRDY) == 0);  // wait for HSI ready
    RCC_SYSCLKConfig(RCC_SYSCLKSource_HSI); // Select system clock source
    RCC_HCLKConfig(RCC_SYSCLK_Div1);  // 16MHz
    RCC_PCLK1Config(RCC_HCLK_Div1);
    RCC_PCLK2Config(RCC_HCLK_Div1);
    RCC_APB1PeriphClockCmd( RCC_APB1ENR_PWREN, ENABLE );
    PWR_MainRegulatorModeConfig(PWR_Regulator_Voltage_Scale1);  // up to 60MHz
